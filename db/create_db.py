...
from memes_bot.config import DB_PATH
...
class Meme(Base):
    ...
    conn = relationship('Tag', backref='connection_tag', single_parent=True, cascade="all, delete-orphan")
...
#     id = Column(Integer, primary_key=True, autoincrement=True, index=True)
#     hash_id = Column(Integer, ForeignKey('memes.id'), unique=False, nullable=False)
